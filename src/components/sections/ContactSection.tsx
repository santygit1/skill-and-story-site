...
const ContactSection = () => {
  ...
  const contactDetails = [
    { 
      icon: Mail, 
      label: 'Email', 
      value: 'santhosh2027ug@buildwithivb.com',
  ...
  return (
    <section id="contact" className="py-12 bg-gradient-to-br from-sky-blue/10 via-creamy-beige/20 to-peach/10">
          ...
          <div className="space-y-6">
            ...
            <Card className="animate-fade-in-up bg-white/80 backdrop-blur-sm border border-white/50 rounded-2xl shadow-xl" style={{ animationDelay: '0.3s' }}>
              ...
              <CardContent>
                <div className="flex gap-4">
                  ...
                  >
                    <a href="https://github.com/santygit1" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2">
                  ...
                  >
                    <a href="https://www.linkedin.com/in/santhosh-kumar-94824b328/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2">
            ...
            <div className="text-center p-6 bg-gradient-to-r from-peach/20 to-sky-blue/20 rounded-2xl animate-fade-in-up" style={{ animationDelay: '0.4s' }}>
              ...
              <p className="text-cosmic-purple font-serif italic">
                "Let's build something extraordinary — from scratch to scale."
              </p>
            </div>
          </div>
        </div>
